...
cityInput.addEventListener("keyup", function (event) {
   if (event.key === "Enter") {
      ...
      var apiKey = "e182a88f6844315e7870fe4c71073ccb"; // Default
      var unit = "metric";
               ...
               fetch(
                  ...
                  .then((data) => {
                     ...
                     data.list.forEach((entry) => {
                        ...
                        if (
                           entry.main.temp_max > dailyForecasts[date].maxTemp
                        ) {
                           dailyForecasts[date].maxTemp = entry.main.temp_max;
                        }
                        if (
                           entry.main.temp_min < dailyForecasts[date].minTemp
                        ) {
      ...
      `;
               ...
               ).innerHTML = maxTemperature + "<sup>o</sup>C";
               document.getElementById(
                  "minTemperatureAdditionalValue"
               ).innerHTML = minTemperature + "<sup>o</sup>C";
